...
class DrawMap:
    ...
    def __init__(self, start, end, colour, zoom_value, width, w, h):
    ...
    def create_points(self, lon, lat):
        folium.PolyLine([lon, lat], color=self.colour, weight=self.line_width, opacity=0.8).add_to(self.folium_map_object)
